...
extern "C" {
    ...
    void WriteIHDRChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_iHDR);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->iHDR->Width);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->iHDR->Height);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->iHDR->BitDepth);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->iHDR->ColorType);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->iHDR->Compression);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->iHDR->FilterMethod);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->iHDR->IsInterlaced);
    }
    ...
    void WriteACTLChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_acTL);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->acTL->NumFrames);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->acTL->TimesToLoop);
    }
    ...
    void WriteFCTLChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_fcTL);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fcTL->FrameNum);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fcTL->Width);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fcTL->Height);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fcTL->XOffset);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fcTL->YOffset);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 16, Options->fcTL->FrameDelayNumerator);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 16, Options->fcTL->FrameDelayDenominator);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->fcTL->DisposeMethod);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->fcTL->BlendMethod);
    }
    ...
    void WriteFDATChunk(PNGOptions *Options, BitBuffer *BitB, uint8_t *DeflatedFrameData, uint32_t DeflatedFrameDataSize) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_fDAT);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->fdAT->FrameNum);
    }
    ...
    void WriteSTERChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_sTER);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->sTER->StereoType);
    }
    ...
    void WriteBKGDChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_bKGD);
        ...
        if (Options->iHDR->ColorType == PNGColor_Palette || Options->iHDR->ColorType == PNGColor_Gray || Options->iHDR->ColorType == PNGColor_GrayAlpha) {
            for (uint8_t Channel = 0; Channel < NumChannels; Channel++) {
                BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, BKGDEntrySize, Options->bkGD->BackgroundPaletteEntry[Channel]);
            }
        } else if (Options->iHDR->ColorType == PNGColor_RGB || Options->iHDR->ColorType == PNGColor_RGBAlpha) {
            for (uint8_t Channel = 0; Channel < NumChannels; Channel++) {
                BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, NumChannels * 16, Options->bkGD->BackgroundPaletteEntry[Channel]);
            }
        }
    }
    ...
    void WriteCHRMChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_cHRM);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->WhitePointX);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->WhitePointY);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->RedX);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->RedY);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->GreenX);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->GreenY);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->BlueX);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->cHRM->BlueY);
    }
    ...
    void WriteGAMAChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_gAMA);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->gAMA->Gamma);
    }
    ...
    void WriteOFFSChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_oFFs);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->oFFs->XOffset);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->oFFs->YOffset);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->oFFs->UnitSpecifier);
    }
    ...
    void WriteICCPChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_iCCP);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, Bytes2Bits(ProfileNameSize), Options->iCCP->ProfileName);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->iCCP->CompressionType);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, Bytes2Bits(CompressedProfileSize), Options->iCCP->CompressedICCPProfile);
    }
    ...
    void WriteSBITChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_sBIT);
        
        if (Options->iHDR->ColorType == PNGColor_RGB || Options->iHDR->ColorType == PNGColor_Palette) {
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Red);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Green);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Blue);
        } else if (Options->iHDR->ColorType == PNGColor_RGBAlpha) {
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Red);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Green);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Blue);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Alpha);
        } else if (Options->iHDR->ColorType == PNGColor_Gray) {
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Grayscale);
        } else if (Options->iHDR->ColorType == PNGColor_GrayAlpha) {
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Grayscale);
            BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8, Options->sBIT->Alpha);
        }
    ...
    void WriteSRGBChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_sRGB);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->sRGB->RenderingIntent);
    }
    ...
    void WritePHYSChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_pHYs);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->pHYs->PixelsPerUnitXAxis);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, Options->pHYs->PixelsPerUnitYAxis);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 8,  Options->pHYs->UnitSpecifier);
    }
    ...
    void WritePCALChunk(PNGOptions *Options, BitBuffer *BitB) {
        ...
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, ChunkSize);
        BitBuffer_WriteBits(BitB, ByteOrder_LSByteIsFarthest, BitOrder_LSBitIsNearest, 32, PNGMarker_pCAL);
